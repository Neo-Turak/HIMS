...
Public Class 数据库连接测试
    ...
    Private Sub OK_Click(sender As Object, e As EventArgs) Handles OK.Click
        ...
        Try
            Dim constr As String = "PROVIDER=" & provider & ";UID=" & UID & ";PWD=" & PWD & ";database=" & database &
                                   ";SERVER=" & server & ";"
    ...
    Private Sub 数据库连接测试_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.Location = New Point((Screen.PrimaryScreen.Bounds.Width / 2) - ((登录.Size.Width / 2) + 25),
                                (Screen.PrimaryScreen.Bounds.Height / 2) + ((登录.Size.Height / 2) - 20))
    End Sub
