...
Public Class 今日挂号报表
    ...
    Private Sub 今日住院报表_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ds1 = New ReportDataSource("今日挂号单_dataset", Get_挂号单详情().Tables(0))
        ds2 = New ReportDataSource("今日挂号单_男_女_DataSet", Get_挂号单详情_男_女.Tables(0))
        ds3 = New ReportDataSource("今日挂号单_结算方式_DataSet", Get_挂号单详情_结算方式.Tables(0))
    ...
    Private Sub 今日挂号报表_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
